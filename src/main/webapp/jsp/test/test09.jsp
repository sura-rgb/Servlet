	...
	<div id="wrap">
		...
		<section class="main-contents">
			<table class="table text-center">
				...
				<tbody>
				<%for(Map<String, String> mapp : list) {
					// 카테고리 값이 null이면
					// 카테고리 값이 있으면 부합하는 채널 정보 보여주기
					if(category == null || category.equals(mapp.get("category"))){
					%>
					<tr>
						<td><%=mapp.get("ch") %></td>
						<td><%=mapp.get("name") %></td>
						<td><%=mapp.get("category") %></td>
					</tr>
					<% } 
				}
					%>
		...
		<footer>
			<div class="text-center" mt-3>Copyright 2024. sk All Rights Resrved.</div>
		</footer>
	</div>
